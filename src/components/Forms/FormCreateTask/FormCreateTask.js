...
import { GET_ALL_PROJECT_SAGA } from '../../../redux/constants/ProjectCyberbugsConstants';
...
const frmCreateTask = withFormik({
    ...
    mapPropsToValues: (props) => {
        ...
        return {
            taskName: '',
            description: '',
            statusId: arrStatus.statusId,
            originalEstimate: 0,
            timeTrackingSpent: 0,
            timeTrackingRemaining: 0,
            projectId: arrProject.id,
            typeId: arrTaskType.id,
            priorityId: arrPriority.priorityId,
            listUserAsign: []
        }
    },
